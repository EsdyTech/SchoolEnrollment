  ...
  $regNo =$_POST['regNo'];
   ...
   $dateCreated = date("Y-m-d");    
    ...
    if($count > 0)
    {
        ...
        phoneNo='$phoneNo',dob='$dob',address='$address',nationality='$nationality',weight='$weight',height='$height',religion='$religion',placeOfBirth='$placeOfBirth',
        state='$state',lga='$lga' where regNo='$regNo'");
        if ($ret) {
        ...
        else
        {
         ...
         $queryy=mysqli_query($con,"insert into tblpersonaldata(regNo,surName,firstName,middleName,sex,phoneNo,dob,address,nationality,weight,height,religion,placeOfBirth,state,lga,dateCreated) 
         value('$regNo','$surName','$firstName','$middleName','$sex','$phoneNo','$dob','$address','$nationality','$weight','$height','$religion','$placeOfBirth','$state','$lga','$dateCreated')");
        if ($queryy) {
             ...
             <div class="section-top-border">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <h3 class="mb-30">Child/Ward Personal Data</h3>
                        <form action="#" method="post">
                            ...
                            <div class="input-group-icon mt-10">
                                ...
                                <input type="text" name="state" value="<?php echo $rowss['state'];?>" placeholder="State" onfocus="this.placeholder = ''"
                                    onblur="this.placeholder = 'State Of Origin'" required class="single-input">                                </div>
                            </div>
                            <div class="input-group-icon mt-10">
                                <div class="icon"><i class="fa fa-globe" aria-hidden="true"></i></div>
                            ...
                            <div class="input-group-icon mt-10">
                                ...
                                <input type="text" name="sex" value="<?php echo $rowss['sex'];?>" placeholder="Sex" required class="single-input">
                            </div>

                            <div class="input-group-icon mt-10">
                                <div class="icon"><i class="fa fa-user" aria-hidden="true"></i></div>
                                <input type="text" name="height" value="<?php echo $rowss['height'];?>" placeholder="Height" required class="single-input">
                            </div>
                            <div class="input-group-icon mt-10">
                                <div class="icon"><i class="fa fa-user" aria-hidden="true"></i></div>
                                <input type="text" name="weight" value="<?php echo $rowss['weight'];?>" placeholder="Weight" required class="single-input">
                            </div>
                            <div class="input-group-icon mt-10">
                                <div class="icon"><i class="fa fa-home" aria-hidden="true"></i></div>
                                <input type="text" name="placeOfBirth" value="<?php echo $rowss['placeOfBirth'];?>" placeholder="Place Of Birth" required class="single-input">
                            </div>
                            <div class="input-group-icon mt-10">
                                <div class="icon"><i class="fa fa-home" aria-hidden="true"></i></div>
                                <input type="text" name="religion" value="<?php echo $rowss['religion'];?>" placeholder="Religion" required class="single-input">
                            </div>
                            <div class="input-group-icon mt-10">
                                <div class="icon"><i class="fa fa-home" aria-hidden="true"></i></div>
                                <input type="text" name="address" value="<?php echo $rowss['address'];?>" placeholder="Address"  required class="single-input">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-4 mt-sm-30">
                        <div class="single-element-widget mt-30">
                            ...
                            <div class="switch-wrap d-flex justify-content-between">
                                <p>Gender: <?php echo $rowss['sex'];?></p>&nbsp;<p>LGA: <?php echo $rowss['lga'];?></p>
                            </div>
                            <div class="switch-wrap d-flex justify-content-between">
                                <p>Phone Number: <?php echo $rowss['phoneNo'];?></p>&nbsp;<p>Height: <?php echo $rowss['height'];?></p>
                            </div>
                            <div class="switch-wrap d-flex justify-content-between">
                                <p>Weight: <?php echo $rowss['weight'];?></p>&nbsp;<p>Religion: <?php echo $rowss['religion'];?></p>
                            </div>
                            <div class="switch-wrap d-flex justify-content-between">
                                <p>Place Of Birth: <?php echo $rowss['placeOfBirth'];?></p>
                            </div>
                        </div>
