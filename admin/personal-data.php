...
if(isset($_GET['regNo']))
{
   ...
   $ret=mysqli_query($con,"SELECT * from tblpersonaldata where regNo = '$regNo'");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Student Personal Data (Registration No: <?php echo $regNo;?>)</h2>
						...
						<div class="panel panel-default">
							<div class="panel-heading">Student Personal Data Info</div>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<tr>
											...
											<td><?php echo htmlentities($row['surName']." ".$row['firstName']." ".$row['middleName']);?></td>
