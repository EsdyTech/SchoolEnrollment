...
if(isset($_GET['regNo']))
{
   ...
   $ret=mysqli_query($con,"SELECT * from tblnextofkin where regNo = '$regNo'");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Student Next Of Kin Data (Registration No: <?php echo $regNo;?>)</h2>
						...
						<div class="panel panel-default">
							<div class="panel-heading">Student Next Of Kin Data Info</div>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<tr>
											...
											<td><?php echo htmlentities($row['nextofkinName']);?></td>
											<td><?php echo htmlentities($row['nextofkinPhoneNo']);?></td>
											<td><?php echo htmlentities($row['nextofkinAddress']);?></td>
