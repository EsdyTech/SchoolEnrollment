    ...
    if($count > 0)
    {
        ...
        $regNo = uniqid();
            ...
            else 
            {
                ...
                $queryy=mysqli_query($con,"insert into tblinitialreg(firstName,lastName,otherName,emailAddress,phoneNo,regNo,admissionNo,isRegComplete,isApproved,dateApproved,dateCreated) 
                value('$firstName','$lastName','$otherName','$emailAddress','$phoneNo','$regNo','','0','0','','$dateCreated')");
                if ($queryy) {
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="single__news">
                        <div class="thumb">
                            <a href="#">
                                <img src="img/admission/student1.jpg" alt="">
                            </a>
                            <span class="badge">Student</span>
                        </div>
                        <div class="news_info">
                            <a href="#">
                                <h4>Welcome to OPMA Nursery and Primary School</h4>
                            </a>
                ...
                <div class="col-md-6">
                    <div class="single__news">
                        <div class="thumb">
                            <a href="#">
                                <img src="img/admission/student2.jpg" alt="">
                            </a>
                            <span class="badge bandge_2">Admission</span>
                        </div>
                        <div class="news_info">
                            <a href="#">
                                <h4>2019/2020 Admission in Progress at OPMA Nursery and Primary School</h4>
                            </a>
                            <p class="d-flex align-items-center"> <span><i class="flaticon-calendar-1"></i> May 10, 2020</span> 
